...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [MAC_BASE] = LAYOUT_ansi(
        ...
        _______, _______, KC_SLEP, _______, _______, _______, _______, _______, KC_INS,  _______, _______, _______,          _______,          KC_END,
        _______, _______, _______, _______, _______, _______, _______, _______, RGB_SAD, RGB_SAI, _______,                   _______, RGB_VAI, KC_HOME,
